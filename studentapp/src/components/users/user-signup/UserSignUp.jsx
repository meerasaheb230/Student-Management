        ...
        <div className="container">
            ...
            <form  className="regisration" onSubmit={submitHandler}>
                <div className="input-group">
                    ...
                    {/* <select class="form-select form-select-sm" aria-label=".form-select-sm example" onClick={onClickHandler}>
                       <option selected>Open this select menu</option>
                         <option value={user.title}>Ms</option>
                         <option value={user.title}>Mr</option>
                         <option value={user.title}>Miss</option>
                    </select> */}
